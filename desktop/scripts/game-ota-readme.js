...
“独立组件/RTX40-MFGUnlock-0.9”是当前补帧解锁组件，来源为 https://github.com/mavismmg/MFGAdaUnlock-RenoDx/ 。旧 0.7 不进入新包，也不提供回退。原生 DLSS FG 必须已可用；安装此组件不会让不支持 FG 的游戏自动获得 FG。优先通过管理器预览、安装和恢复，手工安装仅供了解明确加载目录的用户。
